...
const AGENT_RUN_LOOP_PROMPT_BLOCK = [
  ...
  '',
  'When the user answer makes multiple independent tool calls known, call them in the same assistant tool-call batch instead of stopping after the first one.',
  '',
