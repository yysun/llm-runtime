...
Read this with [[src-builtins]] for catalog shape and [[approval-and-synthetic-tool-call-messages]] for how pending approval artifacts differ from synthetic tool-call messages produced by the turn loop.