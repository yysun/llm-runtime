...
Use this page for the current implementation and preferred public names. Read [[src-turn-loop]] only when you need the compatibility contract for older import paths or deprecated aliases. Related pages: [[host-owned-ask-user-input]], [[timeout-after-tool-result]], [[action-execution-hardening]], [[language-agnostic-continuation]], [[turn-loop-safety-and-lifecycle]], [[approval-and-synthetic-tool-call-messages]], [[src-prompt-contracts]], [[src-runtime]], and [[src-tool-validation]].
