...
- `RuntimeStreamCompleteEvent` includes `tool_calls`, `text_delta`, and `reasoning_delta` events, so streaming callers can separate lifecycle updates from provider-visible deltas.
